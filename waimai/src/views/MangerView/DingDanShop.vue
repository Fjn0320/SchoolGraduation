    ...
    <div>
       <div style="margin: 10px 0">
          ...
          <el-table 
           ...
           <el-table-column prop="shopid" label="订单编号" >
           </el-table-column>
           <el-table-column prop="shopname" label="订单名称" >
           </el-table-column>
           <el-table-column prop="shoping" label="接单商家id" >
           </el-table-column>
           <el-table-column prop="goadress" label="下单人地址" >
            </el-table-column>
            <el-table-column prop="gophone" label="下单人电话" >
            </el-table-column>
            <el-table-column prop="goname" label="下单人" >
            </el-table-column>
            <el-table-column prop="shopmoney" label="订单金额" >
            </el-table-column>
            <el-table-column prop="shopcomment" label="订单备注" >
            </el-table-column>
            <el-table-column prop="shoptime" label="下单时间" >
            </el-table-column>
...
export default {
       ...
       data() {
           return{
               ...
               id:localStorage.getItem("honey-user")?JSON.parse(localStorage.getItem("honey-user")).id:"",
               shopname:"",
               tableData:[], 
               total:0,
               pageNum:1,
       ...
       methods: {
        showPingFen(){
           ...
           request.get("/ding/getPageAllDingShop",{
             params: {
         ...
         openDeletePing(id){//打开删除对话框
           ...
           deletePing(){
           request.post("/ding/dingDelete/"+this.deleteId).then(res => {
                 console.log("删除的数据");
                 console.log(res);
                 if(res){
